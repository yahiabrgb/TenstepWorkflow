...
import TenstepWorkflow.message.ResponseFile;
import TenstepWorkflow.message.ResponseMessage;
import TenstepWorkflow.repositories.DocumentsRepository;
import TenstepWorkflow.services.DocumentsService;
...
public class DocumentsController {
  ...
  @GetMapping("/filesSignature")
	@ResponseBody
	public void VerifSign() throws IOException, MessagingException{
	  DocumentsService.VerifSignature();
	}
